#ifndef _tools_bitmap_hpp_INCLUDED_
#define _tools_bitmap_hpp_INCLUDED_
/// \file tools/bitmap.hpp
/// \author Benjamin Buch (benni.buch@gmail.com)
/// \date 07.05.2009 - 14.02.2013
/// \brief Class template tools::bitmap
///
...
namespace tools {
	...
	public:
		...
		using point_type = tools::point< std::size_t >;

		/// \brief Type of bitmap size
		using size_type = tools::size< std::size_t >;
